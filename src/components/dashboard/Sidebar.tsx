        ...
        <div className="h-screen col-span-2 border border-borderGray flex flex-col items-center overflow-hidden">
            ...
            <div className="flex flex-col items-center w-full px-10 gap-2">
                <div className="border-t border-borderGray w-full px-10 py-10 flex flex-col items-center gap-20">
                    <div className="text-base font-medium flex gap-10 w-full justify-start cursor-pointer" onClick={()=> navigate('/subjects')}> <img src={projects} alt="" /> <div className="">Subjects</div> </div>
                </div>
                <div className="border-t border-borderGray w-full px-10 py-10 flex flex-col items-center gap-20">
                    <div className="text-base font-medium flex gap-10 w-full justify-start cursor-pointer" onClick={()=> navigate('/subjects')}> <img src={projects} alt="" /> <div className="">My Lessons</div> </div>
                </div>
            </div>
        </div>
  )
